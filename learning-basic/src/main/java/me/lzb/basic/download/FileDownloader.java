...
import me.lzb.basic.download.api.DownloadListener;
...
public class FileDownloader {
    //"https://wallpapers.wallhaven.cc/wallpapers/full/wallhaven-499994.png"
    String url;
    ...
    public void execute() {
        ...
        try {
            ...
            createEmptyFile(localFile, length);
    ...
    private void createEmptyFile(String fileName, int contentLen) throws IOException {
    ...
    private int[][] allocateDownloadRange(int threadNum, int contentLen) {
        ...
        ranges[threadNum - 1][1] = ranges[threadNum - 1][1] + left;
